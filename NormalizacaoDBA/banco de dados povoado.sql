...
-- delete from pedidos where livroid is not null;
alter table pedidos drop foreign key pedidos_ibfk_1;
alter table pedidos drop column livroid;

-- delete from pedidos where Quantidade is not null;
...
insert into itenspedido(pedidoid,livroid,quantidade)values(1,1,3),(2,2,2),(3,3,4),(4,4,1),(5,5,2),(6,6,3),(7,7,2),(8,8,1),(9,9,4),(10,10,1),(11,11,2),(12,12,3),(13,14,2),(14,14,2),(15,15,5),(16,1,2),(17,2,3),(18,3,1),(19,4,4),(20,5,2),
(21,6,3),(22,7,1),(23,8,2),(24,9,3),(25,10,1);
select * from itenspedido;

INSERT INTO Pedidos (DataPedido, ValorTotal, LivroID, Quantidade)
VALUES
    ('2023-09-16', 22.99, 1, 3),
    ('2023-09-17', 18.75, 2, 2),
    ('2023-09-18', 14.99, 3, 4),
    ('2023-09-19', 26.50, 4, 1),
    ('2023-09-20', 19.99, 5, 2),
    ('2023-09-21', 29.99, 6, 3),
    ('2023-09-22', 17.75, 7, 2),
    ('2023-09-23', 32.50, 8, 1),
    ('2023-09-24', 21.99, 9, 4),
    ('2023-09-25', 27.75, 10, 1),
    ('2023-09-26', 18.50, 11, 2),
    ('2023-09-27', 24.99, 12, 3),
    ('2023-09-28', 29.75, 13, 1),
    ('2023-09-29', 15.99, 14, 2),
    ('2023-09-30', 28.50, 15, 5),
    ('2023-10-01', 20.99, 1, 2),
    ('2023-10-02', 16.75, 2, 3),
    ('2023-10-03', 24.50, 3, 1),
    ('2023-10-04', 18.99, 4, 4),
    ('2023-10-05', 21.75, 5, 2),
    ('2023-10-06', 23.99, 6, 3),
    ('2023-10-07', 26.50, 7, 1),
    ('2023-10-08', 19.99, 8, 2),
    ('2023-10-09', 15.75, 9, 3),
    ('2023-10-10', 28.50, 10, 1);
